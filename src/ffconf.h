/*---------------------------------------------------------------------------/
 /  Configurations of FatFs Module for Vi*cOS
 /---------------------------------------------------------------------------*/
...
/* This option switches read-only configuration. (0:Read/Write or 1:Read-only)
 /  Read-only configuration removes writi*ng API functions, f_write(), f_sync(),
...
/* This option switches attribute control API functions, f_chmod() and f_utime().
 /  (0:Disable or 1:Enable) Also FF_FS_RE*ADONLY needs to be 0 to enable this option. */
...
/* This option switches volume label API functions, f_getlabel() and f_setlabel().
 ...
 /* This set of options defines size of file name members in the FILINFO structure
  /  which is used to read out directory i*tems. These values should be suffcient for
 ...
 /* This option switches support for multiple volumes on the physical drive.
  /  By default (0), each logical drive nu*mber is bound to the same physical drive
 ...
 /* This set of options configures the range of sector size to be supported. (512,
  /  1024, 2048 or 4096) Always set both 5*12 for most systems, generic memory card and
 ...
 /* This option switches support for ATA-TRIM. (0:Disable or 1:Enable)
  /  To enable this feature, also CTRL_TRI*M command should be implemented to
  /  the disk_ioctl(). */
 ...
 /* This option switches tiny buffer configuration. (0:Normal or 1:Tiny)
  /  At the tiny configuration, size of fi*le object (FIL) is shrinked FF_MAX_SS bytes.
 ...
 /* The option FF_FS_NORTC switches timestamp feature. If the system does not have
  /  an RTC or valid timestamp is not need*ed, set FF_FS_NORTC = 1 to disable the
...
/  These options have no effect in read-only configuration (FF_FS_READONLY = 1). */
 ...
 /* The option FF_FS_REENTRANT switches the re-entrancy (thread safe) of the FatFs
  /  module itself. Note that regardless o*f this option, file access to different
